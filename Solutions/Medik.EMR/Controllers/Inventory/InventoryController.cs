...
using Medik.ServerModel.InventoryModels;
using Microsoft.AspNetCore.Hosting;
using Medik.ViewModel.Procurement;
...
namespace Medik.Controllers
{
    ...
    public class InventoryController : CommonController
    {
        ...
        public InventoryController(Microsoft.AspNetCore.Hosting.IHostingEnvironment env, IOptions<MyConfiguration> _config, IVerificationService verificationService, IInventoryReceiptNumberService receiptNumberService) : base(_config)
        {
