...
using System.Text;
using Medik.ServerModel.NotificationModels;
using Medik.Enums;
using System.IO;
using Medik.ServerModel.CommonModels;
...
namespace Medik.Controllers
{
    ...
    public class PharmacyController : CommonController
    {
        ...
        public PharmacyController(Microsoft.AspNetCore.Hosting.IHostingEnvironment env, IOptions<MyConfiguration> _config) : base(_config)
        {
