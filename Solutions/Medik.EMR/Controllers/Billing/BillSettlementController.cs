...
using Medik.ServerModel.BillingModels;
    ...
    public class BillSettlementController : CommonController
    {
        ...
        public string Get(string reqType, int? patientId, int? settlementId, int billingTransactionId)
        {
            ...
            try
            {
                ...
                {
                    DataTable settlInfo = Medik.DalLayer.DALFunctions.GetDataTableFromStoredProc("SP_TXNS_BILL_SettlementSummary", billingDbContext);
