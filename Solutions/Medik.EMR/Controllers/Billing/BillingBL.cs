...
namespace Medik.Controllers.Billing
{
    public class BillingBL
    {
        ...
        public DateTime GetCounterDay_Active(string connString)
        {
            ...
            {
                Medik.DalLayer.BillingDbContext billingDbcontext = new DalLayer.BillingDbContext(connString);
        ...
        //    Medik.DalLayer.BillingDbContext billDbContext = new DalLayer.BillingDbContext(connString);
