                    ...
                    else
                    {
                        using (var dbContextTransaction = accountingDBContext.Database.BeginTransaction())
                        {
                            try
                            {
                                ...
                                var flag = Medik.AccTransfer.AccountingTransferData.LedgerAddUpdateInBalanceHisotry(ledger, accountingDBContext, false, currentHospitalId,currentUser.EmployeeId);
