...
using Medik.ServerModel.SystemAdminModels;
    ...
    public class SystemAdminController : CommonController
    {
        ...
        private Boolean RestoreDatabase(string connStringAdmin, DatabaseLogModel dbBackupLogDataFromClient)
        {
            try
            {
                ...
                {
                    conAdmin.Open();
                    using (SqlConnection conMedikLive = new SqlConnection(connString))
                    {
                        ...
                        SqlCommand sqlCmdSingleUserMode = new SqlCommand(sqlSetSingleUserModeQuery, conMedikLive);
                        ...
                        SqlCommand sqlCmdRestoreDB = new SqlCommand(sqlRestoreDBQuery, conMedikLive);
                        ...
                        SqlCommand sqlCmdMultiUserMode = new SqlCommand(sqlSetMultiUserModeQuery, conMedikLive);
