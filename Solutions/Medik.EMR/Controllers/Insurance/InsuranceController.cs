...
using Medik.Sync.IRDNepal.Models;
using System.Data.SqlClient;
using System.Threading.Tasks;
using System.Transactions;
using System.Data.Entity.Core.Objects;
using Medik.ServerModel.InsuranceModels;
        ...
        public static void SyncBillToRemoteServer(object billToPost, string billType, InsuranceDbContext dbContext)
        {
            if (billType == "sales")
            {
                ...
                try
                {
                    ...
                    responseMsg = Medik.Sync.IRDNepal.APIs.PostSalesBillToIRD(bill);
                }
                catch (Exception ex)
                {
                    responseMsg = "0";
            ...
            else if (billType == "sales-return")
            {
                ...
                try
                {
                    ...
                    responseMsg = Medik.Sync.IRDNepal.APIs.PostSalesReturnBillToIRD(salesRetBill);
                }
                catch (Exception ex)
                {
                    responseMsg = "0";
