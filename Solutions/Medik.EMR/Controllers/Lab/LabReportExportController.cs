...
namespace Medik.Controllers.Lab
{
    public class LabReportExportController : Controller
    {
        ...
        public LabReportExportController(IOptions<MyConfiguration> _config, Microsoft.AspNetCore.Hosting.IHostingEnvironment hostingEnvironment)
        {
