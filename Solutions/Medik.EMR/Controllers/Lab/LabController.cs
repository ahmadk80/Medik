            ...
            )
        {
            ...
            try
            {
                ...
                else if (reqType == "labReportFromReqIdList")
                {
                    ...
                    {
                        LabReportVM labReport = Medik.Labs.LabsBL.GetLabReportVMForReqIds(labDbContext, reqIdList, CovidReportUrlComonPath);
                    ...
                    try
                    {
                        ...
                        foreach (var reqList in reqIdList)
                        {
                            if (reqList.Count > 0)
                            {
                                ...
                                if (allBarCode != null && allBarCode.Count == 1)
                                {
                                    LabReportVM labReport = Medik.Labs.LabsBL.GetLabReportVMForReqIds(labDbContext, reqList, CovidReportUrlComonPath);
                                    labReport.ValidToPrint = true;
                                    labReport.BarCodeNumber = allBarCode[0];
                ...
                else if (reqType == "allLabTests")
                {
                    ...
                    {
                        testsFromCache = (new Medik.DalLayer.LabDbContext(connString)).LabTests.ToList();
