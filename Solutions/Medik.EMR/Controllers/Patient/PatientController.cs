                ...
                else if (reqType == "patient-search-by-text") // Vikas: 17th June 2019 :added real time search.
                {
                    ...
                    var allPats = (from pat in patDbContext.Patients.Include("Visits")
                                   ...
                                   select new
                                   {
                                       ...
                                       PatientCode = pat.PatientCode,
                                       ShortName = pat.FirstName + " " + (string.IsNullOrEmpty(pat.MiddleName) ? "" : pat.MiddleName + " ") + pat.LastName,
                                       FullName = pat.FirstName + " " + (string.IsNullOrEmpty(pat.MiddleName) ? "" : pat.MiddleName + " ") + pat.LastName +"  ( " + pat.PhoneNumber + " ) ",
                                       FirstName = pat.FirstName,
                                       LastName = pat.LastName,
                                       MiddleName = pat.MiddleName,
                                       Age = pat.Age,
                ...
                else//this is default call.. 
                {
                    var allPats = (from pat in patDbContext.Patients.Include("Visits")
                                   ...
                                   select new
                                   {
                                       ...
                                       PatientCode = pat.PatientCode,
                                       ShortName = pat.FirstName + " " + (string.IsNullOrEmpty(pat.MiddleName) ? "" : pat.MiddleName + " ") + pat.LastName,
                                       FullName = pat.FirstName + " " + (string.IsNullOrEmpty(pat.MiddleName) ? "" : pat.MiddleName + " ") + pat.LastName,
                                       FirstName = pat.FirstName,
                                       LastName = pat.LastName,
                                       MiddleName = pat.MiddleName,
                                       Age = pat.Age,
        ...
        public string Post()
        {
            ...
            try
            {
                ...
                if (reqType == "patient")
                {
                   ...
                   /* NewPatientUniqueNumbersVM newPatientNumber = Medik.Controllers.PatientBL.GetPatNumberNCodeForNewPatient(connString);
                ...
                else if (reqType == "gov-insurance-patient")
                {
                    ...
                    PatientModel govInsNewPatient = Medik.Controllers.PatientBL.GetPatientModelFromPatientVM(govInsClientPatObj, connString, patDbContext);
                    InsuranceModel patInsInfo = Medik.Controllers.PatientBL.GetInsuranceModelFromInsPatientVM(govInsClientPatObj, currentUser.EmployeeId);
                ...
                else if (reqType == "billing-out-patient")
                {
                    ...
                    PatientModel newPatient = Medik.Controllers.PatientBL.GetPatientModelFromPatientVM(billingOutPatVM, connString, patDbContext);
